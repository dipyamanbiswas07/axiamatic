    ...
    <div>
      <div className='relative'>
        ...
        <input
          type='search'
          id='default-search'
          className='block p-4 pl-10 w-full text-base text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 outline-transparent'
      ...
      <ul
        className={`absolute my-2 rounded-md shadow-xl bg-white dropdown-width z-50 ul-mh  ${
          !show && 'hidden'
        }`}
      >
